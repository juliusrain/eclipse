...
669
normal zo
let s:l = 145 - ((31 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
145
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 92 - ((45 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
92
normal! 040l
tabedit js/shaders/ExplosionShaders.js
set splitbelow splitright
wincmd _ | wincmd |
vsplit
1wincmd h
...
1
normal zo
let s:l = 57 - ((56 * winheight(0) + 31) / 63)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
57
...
105
normal zo
let s:l = 78 - ((0 * winheight(0) + 32) / 64)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
78
